...
const modelsInfo = {
    ...
    User: ["id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt"],
...
const outputsInfo = {
    ...
    UserGroupBy: ["id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt", "_count", "_min", "_max"],
    ...
    UserCountAggregate: ["id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt", "_all"],
    UserMinAggregate: ["id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt"],
    UserMaxAggregate: ["id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt"],
...
const inputsInfo = {
    ...
    UserWhereInput: ["AND", "OR", "NOT", "id", "username", "email", "emailVerified", "image", "accounts", "sessions", "createdAt", "updatedAt"],
    UserOrderByWithRelationInput: ["id", "username", "email", "emailVerified", "image", "accounts", "sessions", "createdAt", "updatedAt"],
    UserWhereUniqueInput: ["id", "email"],
    UserOrderByWithAggregationInput: ["id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt", "_count", "_max", "_min"],
    UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt"],
    ...
    UserCreateInput: ["id", "username", "email", "emailVerified", "image", "accounts", "sessions", "createdAt", "updatedAt"],
    UserUpdateInput: ["id", "username", "email", "emailVerified", "image", "accounts", "sessions", "createdAt", "updatedAt"],
    UserCreateManyInput: ["id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt"],
    UserUpdateManyMutationInput: ["id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt"],
    ...
    UserCountOrderByAggregateInput: ["id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt"],
    UserMaxOrderByAggregateInput: ["id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt"],
    UserMinOrderByAggregateInput: ["id", "username", "email", "emailVerified", "image", "createdAt", "updatedAt"],
    ...
    UserCreateWithoutAccountsInput: ["id", "username", "email", "emailVerified", "image", "sessions", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutAccountsInput: ["where", "create"],
    UserUpsertWithoutAccountsInput: ["update", "create"],
    UserUpdateWithoutAccountsInput: ["id", "username", "email", "emailVerified", "image", "sessions", "createdAt", "updatedAt"],
    UserCreateWithoutSessionsInput: ["id", "username", "email", "emailVerified", "image", "accounts", "createdAt", "updatedAt"],
    UserCreateOrConnectWithoutSessionsInput: ["where", "create"],
    UserUpsertWithoutSessionsInput: ["update", "create"],
    UserUpdateWithoutSessionsInput: ["id", "username", "email", "emailVerified", "image", "accounts", "createdAt", "updatedAt"],
